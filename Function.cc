...
void Function::Print() {
    for (int i = 0; i < numOps; i++) {
        ...
        switch (opList[i].myOp) {
            ...
            case PushInt:
                cout << "PushInt," << opList[i].recInput << ")" << endl;
                break;
            case PushDouble:
                cout << "PushDouble," << opList[i].recInput << ")" << endl;
                break;

            case ToDouble:

                cout << "ToDouble," << (double *)opList[i].litInput << ")" << endl;
                break;
            ...
            case IntUnaryMinus:
                ...
                cout << "IntUnaryMinus," << (int *)opList[i].litInput << ")" << endl;
                break;

            case DblUnaryMinus:

                cout << "DblUnaryMinus," << (double *)opList[i].litInput << ")" << endl;
                break;

            case IntMinus:

                cout << "IntMinus," << opList[i].litInput << ")" << endl;
                break;

            case DblMinus:

                cout << "DblMinus," << (double *)opList[i].litInput << ")" << endl;
                break;

            case IntPlus:

                cout << "IntPlus," << (double *)opList[i].litInput << ")" << endl;
                break;

            case DblPlus:

                cout << "DblPlus," << (double *)opList[i].litInput << ")" << endl;
                break;

            case IntDivide:

                cout << "IntDivide," << (int*)opList[i].litInput << ")" << endl;
                break;

            case DblDivide:

                cout << "DblDivide," << (double *)opList[i].litInput << ")" << endl;
                break;

            case IntMultiply:

                cout << "IntMultiply," << opList[i].litInput << ")" << endl;
                break;

            case DblMultiply:

                cout << "DblMultiply," << opList[i].litInput << ")" << endl;
                break;
        }
    }
}
