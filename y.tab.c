...
#line 127 "Parser.y" /* yacc.c:1646  */
    {
	createName = (yyvsp[-5].actualChars);
	newAttList = (yyvsp[-3].myAttList);
...
#line 133 "Parser.y" /* yacc.c:1646  */
	...
	createName = (yyvsp[0].actualChars);
...
#line 166 "Parser.y" /* yacc.c:1646  */
	...
	(yyval.myAttList)->AttInfo = (yyvsp[0].myAttType);
	(yyval.myAttList)->AttInfo->name = (yyvsp[-1].actualChars);
...
#line 173 "Parser.y" /* yacc.c:1646  */
    {
	(yyval.myAttList) = (struct AttList*) malloc (sizeof (struct AttList));
	(yyval.myAttList)->AttInfo = (yyvsp[-2].myAttType);
	(yyval.myAttList)->AttInfo->name = (yyvsp[-3].actualChars);
	(yyval.myAttList)->next = (yyvsp[0].myAttList);
}
...
#line 188 "Parser.y" /* yacc.c:1646  */
    ...
    if(0 == strcmp((yyvsp[0].actualChars), "INTEGER"))
    {
        (yyval.myAttType)->code = INT;
    }
    else if(0 == strcmp((yyvsp[0].actualChars), "DOUBLE"))
    {
        (yyval.myAttType)->code = DOUBLE;
    }
    else if(0 == strcmp((yyvsp[0].actualChars), "STRING"))
    {
